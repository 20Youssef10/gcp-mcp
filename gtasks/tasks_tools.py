...
@server.tool()
@handle_http_errors("complete_task", service_type="tasks")
...
async def complete_task(
    ...
    Args:
        user_google_email (str): The user's Google email address. Required.
        task_list_id (str): The ID of the task list. Required.
        task_id (str): The ID of the task to complete. Required.

    Returns:
        str: Confirmation message of the completion.
    """
    logger.info(
        f"[complete_task] Invoked. Email: '{user_google_email}', Task List: '{task_list_id}', Task: '{task_id}'"
    )
    ...
    title = completed_task.get("title", "Unknown")
    completed_date = completed_task.get("completed", "Unknown")

    confirmation_message = (
        f"Task completed successfully for {user_google_email}: "
        f"'{title}' (ID: {task_id}) - Completed: {completed_date}"
    )

    logger.info(f"Task completed successfully for {user_google_email}")
