...
STORAGE_WRITE_SCOPE = "https://www.googleapis.com/auth/devstorage.write"

# Google Cloud Pub/Sub API scopes
PUBSUB_SCOPE = "https://www.googleapis.com/auth/pubsub"
PUBSUB_READONLY_SCOPE = "https://www.googleapis.com/auth/pubsub.read_only"

# Google Cloud Functions API scopes
CLOUDFUNCTIONS_SCOPE = "https://www.googleapis.com/auth/cloudfunctions"

# Google Workspace Admin SDK scopes
ADMIN_SCOPE = "https://www.googleapis.com/auth/admin.directory.user"
ADMIN_READONLY_SCOPE = "https://www.googleapis.com/auth/admin.directory.user.readonly"
ADMIN_GROUP_SCOPE = "https://www.googleapis.com/auth/admin.directory.group"
ADMIN_GROUP_READONLY_SCOPE = (
    "https://www.googleapis.com/auth/admin.directory.group.readonly"
)

# Google Vault API scopes
...
# Google Maps/Places API (API key based, no OAuth needed for basic usage)
MAPS_SCOPE = "https://www.googleapis.com/auth/mapsplatform"
...
# New service scope groups
STORAGE_SCOPES = [STORAGE_SCOPE, STORAGE_READONLY_SCOPE, STORAGE_WRITE_SCOPE]

PUBSUB_SCOPES = [PUBSUB_SCOPE, PUBSUB_READONLY_SCOPE]

CLOUDFUNCTIONS_SCOPES = [CLOUDFUNCTIONS_SCOPE]

ADMIN_SCOPES = [
    ADMIN_SCOPE,
    ADMIN_READONLY_SCOPE,
    ADMIN_GROUP_SCOPE,
    ADMIN_GROUP_READONLY_SCOPE,
]

VAULT_SCOPES = [VAULT_SCOPE, VAULT_READONLY_SCOPE]

KEEP_SCOPES = [KEEP_SCOPE, KEEP_READONLY_SCOPE]

PHOTOS_SCOPES = [PHOTOS_SCOPE, PHOTOS_READONLY_SCOPE]

YOUTUBE_SCOPES = [YOUTUBE_SCOPE, YOUTUBE_READONLY_SCOPE, YOUTUBE_UPLOAD_SCOPE]

MAPS_SCOPES = [MAPS_SCOPE]
...
TOOL_SCOPES_MAP = {
    ...
    "maps": MAPS_SCOPES,
    "storage": STORAGE_SCOPES,
    "pubsub": PUBSUB_SCOPES,
    "cloudfunctions": CLOUDFUNCTIONS_SCOPES,
    "admin": ADMIN_SCOPES,
    "vault": VAULT_SCOPES,
}
...
TOOL_READONLY_SCOPES_MAP = {
    ...
    "youtube": [YOUTUBE_READONLY_SCOPE],
    "maps": [MAPS_SCOPE],
    "storage": [STORAGE_READONLY_SCOPE],
    "pubsub": [PUBSUB_READONLY_SCOPE],
    "cloudfunctions": [CLOUDFUNCTIONS_SCOPE],
    "admin": [ADMIN_READONLY_SCOPE, ADMIN_GROUP_READONLY_SCOPE],
    "vault": [VAULT_READONLY_SCOPE],
}
